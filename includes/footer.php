    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            if (window.scrollY > headerHeight) {
                ...
                navbar.classList.add('bg-blue-600', 'p-2', 'px-5', 'rounded-lg');
        ...
        function guncelleSepet() {
            ...
            sepet.forEach((id, index) => {
                ...
                urunDiv.className = "flex justify-between items-center bg-gray-100  mb-2 rounded p-1";
                urunDiv.innerHTML = `
